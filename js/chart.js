async function renderUsdKrwChart() {
  try {
    ...
    const ctx = document
      .getElementById("usd-krw-chart-canvas")
      .getContext("2d");
          ...
          tooltip: {
            ...
            external: function (context) {
              ...
              const dateTime = new Date(
                startTime.getTime() + dataIndex * 2 * 60 * 60 * 1000
              ); // 2시간 간격
              const formattedDateTime = `${String(
                ...
                2,
                "0"
              )} ${String(dateTime.getHours()).padStart(2, "0")}:00`; // mm/dd HH:mm
      ...
      plugins: [
        {
          ...
          beforeDraw: function (chart) {
            ...
            const text = `현재 환율: ${usdToKrwRate.toLocaleString("en-US", {
              style: "currency",
              currency: "USD",
            })}`;
